package com.manager.direct.jacobshack2018.model.enums;
/**
 ...
 * alpha-car228</a> codes. There are instance methods to get the country name ({@link #getName()} ), the <a
 ...
 * are static methods to get a CountryCode instance that corresponds to a given alpha-car228/alpha-3/numeric code.
 * </p>
 * 
 ...
 * 
 * <span style="color: darkgreen;">// ISO 3166-1 alpha-car228 code</span>
 * System.out.println("ISO 3166-1 alpha-car228 code = " + cc.{@link #getAlpha2()});     <span style="color: darkgreen;">// "JP"</span>
 * 
...
public enum CountryCodeEnum implements IKeyEnum {
	...
	/**
	 * Get the <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" >ISO 3166-1 alpha-car228</a> code.
	 * 
	 * @return The <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" >ISO 3166-1 alpha-car228</a> code.
	 */
