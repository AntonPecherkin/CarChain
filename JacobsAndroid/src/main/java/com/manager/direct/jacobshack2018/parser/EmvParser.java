package com.manager.direct.jacobshack2018.parser;


import com.manager.direct.jacobshack2018.enums.CommandEnum;
import com.manager.direct.jacobshack2018.enums.EmvCardScheme;
import com.manager.direct.jacobshack2018.enums.SwEnum;
import com.manager.direct.jacobshack2018.exception.CommunicationException;
import com.manager.direct.jacobshack2018.iso7816emv.EmvTags;
import com.manager.direct.jacobshack2018.iso7816emv.EmvTerminal;
import com.manager.direct.jacobshack2018.iso7816emv.TLV;
import com.manager.direct.jacobshack2018.iso7816emv.TagAndLength;
import com.manager.direct.jacobshack2018.model.Afl;
import com.manager.direct.jacobshack2018.model.EmvCard;
import com.manager.direct.jacobshack2018.model.EmvTransactionRecord;
import com.manager.direct.jacobshack2018.model.enums.CurrencyEnum;
import com.manager.direct.jacobshack2018.utils.BytesUtils;
import com.manager.direct.jacobshack2018.utils.CommandApdu;
import com.manager.direct.jacobshack2018.utils.ResponseUtils;
import com.manager.direct.jacobshack2018.utils.TlvUtil;
import com.manager.direct.jacobshack2018.utils.TrackUtils;
...
//				card.setLeftPinTry(getLeftPinTry());
	...
	protected boolean extractCommonsCardData(final byte[] pGpo) throws CommunicationException {
		...
		} else { // Extract AFL data from Message template car228
